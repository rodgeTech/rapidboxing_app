...
export default function Form({rates, onSubmit, lineItem}) {
  const selectedRate = rates.find(rate => rate.id === lineItem.shippingRateId);

  const initialValues = {
    details: lineItem ? lineItem.details : '',
    link: lineItem ? lineItem.link : '',
    quantity: lineItem ? lineItem.quantity.toString() : '1',
    price: lineItem ? lineItem.price.toString() : '',
    extraPounds: lineItem ? lineItem.extraPounds : '',
    localPickup: lineItem ? lineItem.localPickup : false,
    shippingRate: lineItem ? selectedRate : '',
  };
          ...
          <View
            ...
            <CheckBox
              ...
              onChange={nextChecked =>
                setFieldValue('localPickup', nextChecked)
              }>
