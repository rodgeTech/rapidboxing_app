...
export default createBottomTabNavigator({
  ...
  NewOrder: {
    ...
    navigationOptions: {
      tabBarLabel: 'Order',
      tabBarIcon: ({ tintColor }) => (
        <Icon name='shopping-bag-outline' fill={tintColor} width={25} height={25} />
      )
    }
  },
  Calculator: {
    ...
    navigationOptions: {
      ...
      tabBarIcon: ({ tintColor }) => (
        <Icon name='smartphone-outline' fill={tintColor} width={25} height={25} />
      )
    }
  },
  You: {
  ...
  Cart: {
    ...
    navigationOptions: {
      tabBarIcon: ({ tintColor }) => (
        <Icon name='shopping-cart-outline' fill={tintColor} width={25} height={25} />
      )
    }
  },
